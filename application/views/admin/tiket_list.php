    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                        ...
                        <table id="myTable" class="table table-striped" style="width:100% ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($ticket->username, ENT_QUOTES, 'UTF-8') ?></td>
                                    <td><?= htmlspecialchars($ticket->bagian, ENT_QUOTES, 'UTF-8') ?></td>
                                    <td><?= htmlspecialchars($ticket->tipe_request, ENT_QUOTES, 'UTF-8') ?></td>
                                    <td><?= htmlspecialchars($ticket->detail, ENT_QUOTES, 'UTF-8') ?></td>
                                    <td><?= htmlspecialchars($ticket->prioritas, ENT_QUOTES, 'UTF-8') ?></td>
                                    <td><?= htmlspecialchars($ticket->status, ENT_QUOTES, 'UTF-8') ?></td>
                                    <td>
                                        <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#editTiketModal<?= $ticket->id ?>">
                                            Edit
                                        </button>
                                    </td>
                                </tr>
                ...
                <!-- Modal -->
                <?php foreach($tickets as $ticket): ?>
                <div class="modal fade" id="editTiketModal<?= $ticket->id ?>" tabindex="-1" aria-labelledby="editTiketLabel<?= $ticket->id ?>" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editTiketLabel<?= $ticket->id ?>">Tiket</h5>
