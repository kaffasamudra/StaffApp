...
class Auth extends CI_Controller {
    ...
    public function log_login($id) {
        $file_path = APPPATH . 'logs/login_logs.json';
        ...
        // Baca file JSON jika sudah ada, atau buat array baru jika belum ada
        ...
        // Simpan kembali data dalam bentuk JSON
